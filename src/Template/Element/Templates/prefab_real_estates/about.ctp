<!-- Begin Header -->
<?php echo $this->element('Templates/prefab_real_estates/header'); ?>
<!-- End Header -->
<!-- courses -->
<div class="courses">
    <div class="container"> 
        ...
        <div class="agileits_w3layouts_team_grids w3ls_courses_grids">
            ...
            <div class="col-md-6 agileits_courses_right">
                <img src="<?php echo $this->request->webroot; ?>img/web-samples/prefab_real_estates/g2.jpg" alt=" " class="img-responsive" />
            </div>
...
<div class="team-w3ls">
    <div class="container"> 
        <div class="w3l-heading">
            <h3 class="w3ls_head">Our Skills</h3>
        </div>
        <div class="agileits_w3layouts_team_grids">
            ...
            <div class="col-md-6 w3l_stats_bottom_grid_right">
                <div class='bar_group'>
                    <div class='bar_group__bar thin elastic' label='Building Design' value='230'>
                        <div class='w3ls_bar_group__bar_pos'>
                            <p>65%</p>
                        </div>
                    </div>
                    <div class='bar_group__bar thin elastic' label='Office Design' value='130'>
                        <div class='w3ls_bar_group__bar_pos'>
                            <p>35%</p>
                        </div>
                    </div>
                    <div class='bar_group__bar thin elastic' label='Apartment' value='160'>
                        <div class='w3ls_bar_group__bar_pos'>
                            <p>45%</p>
                        </div>
                    </div>
                    <div class='bar_group__bar thin elastic' label='Room Design' value='340'>
                        <div class='w3ls_bar_group__bar_pos'>
                            <p>100%</p>
                        </div>
                    </div>
...
<!-- //about -->
<!-- Begin Header -->
<?php echo $this->element('Templates/prefab_real_estates/footer'); ?>
<!-- End Header -->